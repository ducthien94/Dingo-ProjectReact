...
const singleBlog=({articles})=>{
    ...
    <li><a href="#"><i className="far fa-user" />{articles.author}</a></li>
                                            <li><a href="#"><i className="far fa-comments" /> 1000000 Comments</a></li>
                                        </ul>
                                        <p className="excert">
                                ...
                                <div className="blog_right_sidebar">
                                    ...
                                    <aside className="single_sidebar_widget newsletter_widget">
                                        ...
                                        <form action="#">
                                            ...
                                            <button className="button rounded-0 primary-bg text-white w-100 btn_4" type="submit">Subscribe</button>
                                        </form>
                                    </aside>
                                </div>
                            </div>
...
singleBlog.getInitialProps = async function () {
    let article = await firebase.firestore().collection("articles").where("id","==",9)
      .get()
      .then(snapshot => {
        let arrData = [];
